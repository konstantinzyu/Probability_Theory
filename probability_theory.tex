...
\begin{document}
	...
	Матожидание $ \expect(\xi - \expect\xi)^k $ называется 
	...
	\begin{proposition}
		...
		$$ \disp(\sum\limits_{i = 1}^{n} \xi_i) = \sum\limits \disp\xi_i + 2\sum\limits_{i < j}\cov(\xi_i,\xi_j). $$
	\end{proposition}
	...
	\subsection{Вычисление матожиданий и дисперсий некоторых случайных величин}
	...
	\begin{theorem}[Неравенства Чебышёва и Маркова]
		Пусть $ \xi $ --- неотрицательная случайная величина. Тогда при дополнительных условиях имеют место следующие неравенства.
		\begin{enumerate}
			\item Если существует матожидание $ \expect\xi $, то справедливо первое неравенство Чебышёва 
			$ \prob(\xi \geqslant ) $
		\end{enumerate}
	\end{theorem}
