...
\begin{document}
	...
	\subsection{Произведение в категории измеримых пространств}
	...
	Величины $ \expect\xi^n $ обозначаются $ \alpha_n $ и называются \defin{моментами случайной величины $ \xi $}.
	Величины $ \expect|\xi|^n $ обозначаются $ \beta_n $ и называются \defin{абсолютными моментами случайной величины $ \xi $}.
	...
	Кроме <<среднего значения>> нам также хотелось бы знать абсолютное отклонение от него,
	...
	\begin{proposition} \label{dispersion prop}
		...
		\begin{enumerate}
			...
			то $$ \disp(\xi + \eta) = \disp(\xi) + \disp(\eta) + 2\expect(\xi - \expect\xi)(\eta - \expect\eta). $$
		\end{enumerate}
	\end{proposition} 
