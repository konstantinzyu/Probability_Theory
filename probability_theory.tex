...
\begin{document}
	...
	\begin{theorem} \label{independence and expectation}
	...
	%\item $ f_\xi $ является вещественной функцией тогда и только тогда,
	%когда $ \xi $ \hyperlink{symmetric-distribution}{симметрично распределена};
	%\label{characteristic function prop | real}
