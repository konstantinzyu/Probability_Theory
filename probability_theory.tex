...
\begin{document}
	...
	Также вместо громоздких выражений $ \prob(\xi^{-1}((-\infty; b))), \prob(\xi^{-1}((a; +\infty))), \prob(\xi^{-1}((a; b))) $ 
	...
	\begin{theorem}
		...
		и $ M_\xi $ --- $ \sigma $-алгебра измеримых относительно неё подмножеств.
		Тогда алгебра $ M_\xi $ совпадает с прямым образом $ \xi_*(\events) $ исходной $ \sigma $-алгебры событий $ \events $,
		а мера $ \mu_\xi $ --- с прямым образом $ \xi_*\prob $ вероятностной меры $ \prob $.
	\end{theorem}
